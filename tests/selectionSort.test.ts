import {SelectionSort} from '../src/sorting-algo/selection'
...
describe("Selection Sort", () => {
  ...
  test("Numbers with duplicates", () => {
    expect(SelectionSort([3, 5, 3, 2, 2, 1])).toEqual([1, 2, 2, 3, 3, 5]);
  });
  ...
  test("Negative numbers", () => {
    expect(SelectionSort([-3, -1, -7, -4, -5])).toEqual([-7, -5, -4, -3, -1]);
  });

  test("Mixed positive and negative numbers", () => {
    expect(SelectionSort([3, -2, -5, 0, 7, -1])).toEqual([-5, -2, -1, 0, 3, 7]);
  });

  test("Large numbers", () => {
    expect(SelectionSort([1000, 500, 100000, 250, 750])).toEqual([250, 500, 750, 1000, 100000]);
  });

  // Floats
  test("Floating point numbers", () => {
    expect(SelectionSort([3.2, 1.5, 4.8, 2.1])).toEqual([1.5, 2.1, 3.2, 4.8]);
  });

  test("Mixed integers and floats", () => {
    expect(SelectionSort([3, 1.2, 4.5, 2, 0.8])).toEqual([0.8, 1.2, 2, 3, 4.5]);
  });
  ...
  test("Already sorted strings", () => {
    expect(SelectionSort(["a", "b", "c", "d"])).toEqual(["a", "b", "c", "d"]);
  });

  test("Strings with upper & lower case", () => {
    expect(SelectionSort(["apple", "Banana", "cherry"])).toEqual(["Banana", "apple", "cherry"]);
  });
  ...
  it("should sort strings alphabetically", () => {
    expect(SelectionSort(["banana", "apple", "cherry"])).toEqual([
      "apple",
      "banana",
      "cherry",
    ]);
  ...
  it("should sort booleans (false before true)", () => {
    expect(SelectionSort([true, false, true, false])).toEqual([
      false,
      false,
      true,
      true,
  ...
  it("should handle mixed-type array (numbers, strings)", () => {
    ...
    const sorted = SelectionSort(arr, (a, b) =>
